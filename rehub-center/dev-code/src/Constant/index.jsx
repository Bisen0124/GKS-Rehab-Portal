...
export const LoginTitle ="Sign in to Rehab Center";
export const LoginsubTitle ="Enter your email or phone & password to login";
...
//Patient first assessment by family start / परिवार द्वारा मरीज का प्रथम मूल्यांकन स्टार्ट
//section 1
...
export const patientAge = "Age/उम्र :";
export const dependentTo = "Dependent To/निर्भरता का प्रकार :";
export const substanceUsePattern = "Substance Use Pattern / पदार्थ उपयोग पैटर्न :";
export const last30DaysQuantity = "Last 30 Days Quantity / पिछले 30 दिनों की मात्रा :";
...
//section 3
export const tableNumber2 = "S./क्र.";
export const complicationDetails = "Complication Details / जटिलता विवरण";
export const yes = "Yes / हाँ ";
export const no = "NO/नहीं ";
...
export const shaking = "Shaking or trembling / हिलना या कांपना";   
export const memory = "Memory Loss / यादाश्त जाना ";  
export const neuropathy = "Neuropathy न्यूरोपैथी (सुन्नता या झुनझुनी)";  
export const blackout = "Blackout / ब्लैक आउट ";  
...
//section 5
export const prepared = "Prepared By/प्रिपेर्ड बाय :";
...
export const familyHistory = "Name of Patient / मरीज का नाम";
export const relation = "Occupational status? / कार्य विवरण?";
export const occupation = "Occupational status? / कार्य विवरण?";
export const marital = "Marital Status? / वैवाहिक स्थिति?";
export const living = "Living Situation / रहने की स्थिति";
export const religion = "Religion / धर्म";
export const caste = "Caste / जात";
//section 3
export const substanceDependency = " Substance Use Dependency / नशीले पदार्थ उपयोग निर्भरता ";
export const durationOfRegularUse = "Duration of regular use? / कब से पदार्थ निर्भर हैं? ";
...
export const TheftInHome = "5.Theft in home / 5.घर में चोरी";
export const ByBluff = "6.by bluff / 6.झांसा देकर";
...
// export const alwaysWorried = "Always worried? / हमेशा चिंतित रहते हैं?";
// export const alwaysSad = "Always Sad? / हमेशा उदास रहते हैं?  ";
// export const lackOfConfidence = "Lack of confidence? / आत्मविश्वास की कमी? ";
// export const stubbornNature = "Stubborn nature? / जिद्दी स्वभाव? ";
// export const instantAggressive = "Instant and too much aggressive? / तत्काल और बहुत अधिक आक्रामक? ";
// export const usesSlang = "Uses Slang language? (Bad words)  / अपशब्दों का प्रयोग करता है? (बुरे शब्द)";
// export const usesBadLanguage = "Uses Bad language? (Bad words) / अपशब्दों का प्रयोग करता है? (बुरे शब्द)";
// export const disrespects = "Disrespects parents? (does not agree to anything) / माता -पिता का अनादर करता है?";
// export const disrespectsParents = "Disrespects parents? (does not agree to anything) / माता -पिता का अनादर करता है?";
// export const haveFightArgue = "Have fight argue with everyone? / क्या हर किसी से झगड़ा बहस होती है? ";
// export const vandalseHouse = "Vandalizes the house? / घर में तोड़फोड़ करते  है?";
// export const vandalizesHouse = "Vandalizes the house? / घर में तोड़फोड़ करते  है?";
// export const doesFightAtHome = "Does fight at home? (with mother, father, wife, children, brother, sister) क्या घर पर झगड़ते हैं? (मातापिता, पत्नीबच्चों, भाईबहन के साथ) ";
// export const expensive = "Is it too expensive? (not value money) / क्या बहुत खर्चीले हैं? (पैसे की कीमत नहीं) ";
// export const stealsthieft = "Steals Theft? / क्या चोरी की है?";
// export const stealTheft = "Steals Theft? / क्या चोरी की है?";
// export const borrows = "Borrows? / क्या उधार लिया है?";
// export const doGambles = "Do gambles/speculate? / क्या जुआ खेलते हैं / सट्टा खेलते हैं? ";
// export const bluffPeople = "Did you Bluff the people? / क्या लोगों को झांसा (ब्लफ)दिया?";
// export const admitMistakes = "Admit mistakes? / क्या अपनी गलती स्वीकार करते है?";
// export const thereNoResponsibility = "There is no sense of responsibility? / क्या जिम्मेदारी का कोई अहसास नहीं है?  ";
// export const selfiesInNature = "Selfish in nature? / स्वभाव से स्वार्थी? ";
// export const doCompassion = "Do Compassion and sympathy for anyone? / किसी  के प्रति दया और सहानुभूति है? ";
// export const areLazy = "Are lazy/slacker/careless? /  क्या आप आलसी/सुस्त/लापरवाह हैं?"; 
// export const nervous = "Can you get nervous & anxiety without getting drugs ?  क्या आपको  बिना नशे के घबराहट,चिड़ चिड़ाहट और चिंता होती  हैं? ";
// export const doPatientsEmotional = "Do patients become very emotional after taking substance abuse? क्या मादक पदार्थ के सेवन के बाद मरीज़ बहुत भावुक हो जाते हैं?";
// export const financialResponsibility = "Do patient put the purchase of Substance ahead of his financial Responsibility? क्या मरीज़ मादक पदार्थ की खरीद को अपनी वित्तीय जिम्मेदारी से आगे रखते हैं?";
// export const defensivePatient = "Have Patient ever felt defensive, guilty, or ashamed about substance abuse? क्या मरीज़ ने कभी  मादक पदार्थ के सेवन के बारे में रक्षात्मक, दोषी या शर्म महसूस की है?";
// export const avoidPeoplePlace = "Do you avoid type of people or places? who dislike your Substance addiction. क्या आप ऐसे लोगों या स्थानों से बचते हैं जो आपकी मादक पदार्थ लत को नापसंद करते हैं?";
// export const abuseProblemInSleeping = "Did Substance abuse problems in sleeping and eating? क्या मादक पदार्थ के सेवन से सोने और खाने में समस्या होती है?";
// export const knowingBadResult = "Knowing bad result did patient abuse Substance ? क्या बुरे परिणाम जानते हुए भी मरीज़ मादक पदार्थ का प्रयोग करता है?";
// export const triedSuicide = "Ever talked about or tried suicide?/  कभी आत्महत्या की बात की या प्रयास किया?";
// export const yourLovedOne = "Do you think your loved one is an Substance dependent? क्या आपको लगता है कि आपका प्रियजन मादक द्रव्यों पर निर्भर है?";



export const patientBehaviorFormattedList = [
  { key: "uses_alone", label: "Do ever use Substance alone? / क्या अकेले मादक पदार्थ उपयोग करते हैं?" },
  { key: "moody", label: "Moody personality? / मूडी व्यक्तित्व?" },
  { key: "worried", label: "Always worried? / हमेशा चिंतित रहते हैं?" },
  { key: "sad", label: "Always Sad? / हमेशा उदास रहते हैं?" },
  { key: "lacks_confidence", label: "Lack of confidence? / आत्मविश्वास की कमी?" },
  { key: "stubborn", label: "Stubborn nature? / जिद्दी स्वभाव?" },
  { key: "aggressive", label: "Instant and too much aggressive? / तत्काल और बहुत अधिक आक्रामक?" },
  { key: "uses_slang", label: "Uses Slang language? (Bad words)  / अपशब्दों का प्रयोग करता है? (बुरे शब्द)" },
  { key: "uses_bad_language", label: "Uses Bad language? (Bad words) / अपशब्दों का प्रयोग करता है? (बुरे शब्द)" },
  ...
  { key: "borrows", label: "Borrows? / क्या उधार लिया है?" },
  { key: "gambles", label: "Do gambles/speculate? / क्या जुआ खेलते हैं?" },
  { key: "bluffs", label: "Did you Bluff the people? / क्या लोगों को झांसा दिया?" },
  { key: "admits_mistake", label: "Admit mistakes? / क्या अपनी गलती स्वीकार करते हैं?" },
  ...
  { key: "feels_guilty", label: "Have Patient ever felt defensive, guilty, or ashamed about substance abuse? / क्या मरीज़ ने कभी मादक पदार्थ के सेवन के बारे में शर्म महसूस की है?" },
  { key: "avoids_people", label: "Do you avoid type of people or places who dislike your Substance addiction? / क्या आप ऐसे लोगों या स्थानों से बचते हैं जो आपकी लत को नापसंद करते हैं?" },
  { key: "sleep_eat_problem", label: "Did Substance abuse problems in sleeping and eating? / क्या मादक पदार्थ के सेवन से सोने और खाने में समस्या होती है?" },
  { key: "uses_knowing_consequence", label: "Knowing bad result did patient abuse Substance? / क्या बुरे परिणाम जानते हुए भी मरीज़ मादक पदार्थ का प्रयोग करता है?" },
  { key: "suicide_thoughts", label: "Ever talked about or tried suicide? / कभी आत्महत्या की बात की या प्रयास किया?" },
  { key: "loved_one_dependence", label: "Do you think your loved one is a Substance dependent? / क्या आपको लगता है कि आपका प्रियजन मादक द्रव्यों पर निर्भर है?" }
];
...
export const maritalStatus = [
  ...
  {
    value: "single",
    label: "Single (अविवाहित)"
  },
  {
    value: "married",
    label: "Married (विवाहित)"
  },
  {
    value: "widowed",
    label: "Widowed (विधवा/विधुर)"
  },
  {
    value: "divorced",
    label: "Divorced (तलाकशुदा)"
  },
  {
    value: "separated",
    label: "Separated (अलग हुए)"
  },
  {
    value: "others",
    label: "Others"
...
export const livingSituation = [
  { value: "", label: "Select" },
  { value: "alone", label: "Living Alone (अकेले रहना)" },
  { value: "with-family", label: "With Family (परिवार के साथ)" },
  { value: "with-roommates", label: "With Roommates (रूममेट्स के साथ)" },
  { value: "hostel", label: "Hostel/PG (हॉस्टल / पीजी में)" },
...
export const religionOptions = [
  ...
  { value: "muslim", label: "Muslim (मुसलमान)" },
  { value: "christian", label: "Christian (ईसाई)" },
  { value: "sikh", label: "Sikh (सिख)" },
  { value: "buddhist", label: "Buddhist (बौद्ध)" },
...
export const FamilyHistory = {
  motherSide: {
      grandmother: { alc: false, drug: false, psych: false },
      grandfather: { alc: false, drug: false, psych: false },
      mother: { alc: false, drug: false, psych: false },
      aunt: { alc: false, drug: false, psych: false },
      uncle: { alc: false, drug: false, psych: false }
  },
  fatherSide: {
      grandmother: { alc: false, drug: false, psych: false },
      grandfather: { alc: false, drug: false, psych: false },
      father: { alc: false, drug: false, psych: false },
      aunt: { alc: false, drug: false, psych: false },
      uncle: { alc: false, drug: false, psych: false }
  },
  others: ""
...
export const currentstatusObject=[
  { value: "Healthy", label: "Healthy / स्वस्थ" },
  { value: "Under Treatment", label: "Under Treatment / उपचाराधीन" },
  { value: "Recovered", label: "Recovered / ठीक हो गया" },
  { value: "Deceased", label: "Deceased / मृत" },
  { value: "Other", label: "Other / अन्य" }
]


export const riskOptions = [
  "Substance Abuse / नशे की लत",
  "Self-Harm / आत्म-क्षति",
  "Aggressive Behavior / आक्रामक व्यवहार",
  "Reckless Driving / लापरवाह ड्राइविंग",
  "Unsafe Sexual Behavior / असुरक्षित यौन व्यवहार",
  "Gambling / जुआ",
  "Other / अन्य"
];
//Education Status: शिक्षा की स्थिति:
...
//FPA Data
export const FirstPhysicalAssessment ="First Physical Assessment";
...
export const ComplicationTitle="Complication Details / जटिलता विवरण";
export const complicationsDetailsData = [
  { id: 1, label: "Ulcers / अल्सर" },
  { id: 2, label: "Respiratory Problem COPD/TB / श्वसन संबंधी समस्याएं सी. ओ. पी. डी. /टीबी" },
  { id: 3, label: "Jaundice / पीलिया" },
  { id: 4, label: "Haematemesis / Malena / खून की उल्टी" },
  { id: 5, label: "Other Abdominal Complaints / पेट की अन्य शिकायतें" },
  { id: 6, label: "Cardiovascular (Chest Pain, Dyspnoea) / हृदय संबंधी (सीने में दर्द, श्वास कष्ट)" }
];

//Neurological / न्यूरोलॉजिकल
export const NeurologicalTitle ="Neurological / न्यूरोलॉजिकल";
export const neurologicalComplications = [
  { id: 1, label: "Seizure / Fits / दौरा/फिट्स" },
  { id: 2, label: "Epilepsy / मिर्गी" },
  { id: 3, label: "Delirium (hallucinations) / प्रलाप (मतिभ्रम)" },
  { id: 4, label: "Shaking or trembling / हिलना या कांपना" },
  { id: 5, label: "Memory Loss / यादाश्त जाना" },
  { id: 6, label: "Neuropathy / न्यूरोपैथी (सुन्नता या झुनझुनी)" },
  { id: 7, label: "Blackout / ब्लैक आउट" }
];

//Nutritional Status / नुट्रिशन स्तिथि 
export const NutritionalStatus ="Nutritional Status / नुट्रिशन स्तिथि";
...
//Sexual History / यौन इतिहास Data

export const SexualHistory = "Sexual History / यौन इतिहास";
export const SexualHistoryID = "ID";
...
export const SexuaQuesData = [
  { en: "Did you have sex misconceptions?", hi: "क्या आपके पास यौन भ्रांतियाँ थीं?" },
  { en: "Do you recall playing any games with sexual content as a child (i.e. Doctor)?", hi: "क्या आपको बचपन में यौन सामग्री वाले खेल खेलने की याद है (जैसे डॉक्टर)?" },
  { en: "Did you have any unpleasant experiences with undue physical intimacy by strangers or a family member or friend?", hi: "क्या आपके साथ किसी अजनबी, परिवार के सदस्य या मित्र द्वारा अनुचित शारीरिक निकटता का कोई अप्रिय अनुभव हुआ था?" },
  { en: "Do you have a bad attitude toward nudity (or modesty)?", hi: "क्या आपके पास नग्नता (या विनम्रता) के प्रति नकारात्मक दृष्टिकोण है?" },
  { en: "Age at first sexual activity", hi: "पहली यौन गतिविधि की आयु" },
  { en: "Consensual/non-consensual", hi: "सहमति/असहमति" },
  { en: "Current sexual functioning", hi: "वर्तमान यौन क्रियाशीलता" },
  { en: "Which kind of sex desire do you have?", hi: "आपके पास किस प्रकार की यौन इच्छा है?" },
  { en: "Describe your sexual identity? Are you comfortable with it?", hi: "अपनी यौन पहचान का वर्णन करें? क्या आप इसके साथ सहज हैं?" },
  { en: "Did you read erotic material? Go to pornographic movies?", hi: "क्या आपने कामुक सामग्री पढ़ी? क्या आप अश्लील फिल्मों में गए?" },
  { en: "Masturbation history (age, attitude, etc.)", hi: "हस्तमैथुन इतिहास (आयु, दृष्टिकोण आदि)" },
  { en: "How often did you masturbate during these years?", hi: "इन वर्षों के दौरान आपने कितनी बार हस्तमैथुन किया?" },
  { en: "How often do you have intercourse?", hi: "आप कितनी बार संभोग करते हैं?" },
  { en: "How do you see the place of sex in marriage? Is it very important to you or not?", hi: "आप विवाह में सेक्स की जगह को कैसे देखते हैं? क्या यह आपके लिए बहुत महत्वपूर्ण है या नहीं?" },
  { en: "Do you tell your partner what you do and do not like during sex?", hi: "क्या आप अपने साथी को बताते हैं कि आपको सेक्स के दौरान क्या पसंद और क्या नापसंद है?" },
  { en: "Did you masturbate after marriage because you did not get satisfaction?", hi: "क्या आपने शादी के बाद हस्तमैथुन किया क्योंकि आपको संतुष्टि नहीं मिली?" },
  { en: "Do you think your partner has any sexual problems?", hi: "क्या आपको लगता है कि आपके साथी को कोई यौन समस्या है?" },
  { en: "Do you have extra-marital affairs?", hi: "क्या आपके विवाहेतर संबंध हैं?" },
  { en: "Have you experienced coitus outside of your marriage relationship?", hi: "क्या आपने अपने विवाह संबंध के बाहर संभोग का अनुभव किया है?" },
  { en: "What did you think of the women who would have intercourse with you? What about the women who refused?", hi: "उन महिलाओं के बारे में आप क्या सोचते थे जो आपके साथ संभोग करती थीं? जो मना करती थीं उनके बारे में क्या?" },
  { en: "Did you use external aids for sex (porn, medicine, physical aids)?", hi: "क्या आपने सेक्स के लिए बाहरी सहायक सामग्री (अश्लील सामग्री, दवाएं, शारीरिक उपकरण) का उपयोग किया?" },
  { en: "Are there upsetting experiences that may relate? Psychiatric problems? Other medical problems?", hi: "क्या कोई परेशान करने वाले अनुभव हैं जो संबंधित हो सकते हैं? मनोरोग संबंधी समस्याएं? अन्य चिकित्सा समस्याएं?" },
  { en: "Did you have a desire for sex before and after substance use?", hi: "क्या आपको पदार्थ उपयोग से पहले और बाद में सेक्स की इच्छा थी?" },
  { en: "Have you experienced premature ejaculation due to substance abuse?", hi: "क्या आपने नशीली दवाओं के दुरुपयोग के कारण शीघ्रपतन का अनुभव किया है?" },
  { en: "Have alcohol, drugs, or the use of a condom affected your ejaculation?", hi: "क्या शराब, नशीली दवाओं या कंडोम के उपयोग ने आपके स्खलन को प्रभावित किया है?" },
  { en: "How does this compare with your frequency in the past?", hi: "यह आपकी पिछली आवृत्ति की तुलना में कैसा है?" },
  { en: "Heterosexual activity/homosexual activity", hi: "विषमलैंगिक गतिविधि/समलैंगिक गतिविधि" }
];
