...
import FormWizard from "../Components/Forms/FormLayout/FormWizard1/form-wizard";
...
//PFA Patient first Assessment by Family
import PFA from '../Components/PFA-Menu/pfa';
//Gen_Family 
import GenFamily from '../Components/Gen-Family/genFamily';
//Registration
import Register from "../Components/registeration/register";
//FPA
import FPA from '../Components/FPA/First-Physical-Assessment';
//FE
import FE from '../Components/FE/First-Examination';
//BA
...
import RelationshipFamily from "../Components/CBT_Intake_Sex_D/RelationshipFamily";
//6.2.4 Childhood
import Childhood from "../Components/CBT_Intake_Sex_D/Childhood";
//6.2.5 Social Behavior 
import SocialBehavior from "../Components/CBT_Intake_Sex_D/SocialBehavior";
//6.2.6 Legal
import Legal from "../Components/CBT_Intake_Sex_D/Legal";
//6.2.7 Patient Behavior 
import PatientBehavior from "../Components/CBT_Intake_Sex_D/PatientBehavior";


//Brief Intervation
import BriefIntervation from "../Components/Brief_Intervantion/BriefIntervation";
//Discharge Follow Up
...
export const routes = [
  ...
  //PFA
  { path: `${process.env.PUBLIC_URL}/PFA-Menu/pfa`, Component : <PFA/>},

  //Gen_Family
  { path: `${process.env.PUBLIC_URL}/Gen-Family/gen-family`, Component : <GenFamily/>},

  //FPA
  // { path: `${process.env.PUBLIC_URL}/FPA/First-Physical-Assessment`, Component : <FPA/>},

   //FE 
   { path: `${process.env.PUBLIC_URL}/FE/First-Examination`, Component : <FE/>},
 
   //BA
   { path: `${process.env.PUBLIC_URL}/BA/Blood-Analysis`, Component : <BA/>},
   ...
   //6.1 CBT
   { path: `${process.env.PUBLIC_URL}/CBT_Intake_Sex_D/CBT`, Component : <CBT/>},
   //6.2.1 Personal Details
   {path: `${process.env.PUBLIC_URL}/CBT_Intake_Sex_D/PersonalDetails`,Component : <PersonalDetail/>},
   //6.2.2 SUD Brief 
   {path: `${process.env.PUBLIC_URL}/CBT_Intake_Sex_D/SUDBrief`, Component : <SUDBrief/>},
   //6.2.3 Relationship & Family 
   {path: `${process.env.PUBLIC_URL}/CBT_Intake_Sex_D/RelationshipFamily`, Component : <RelationshipFamily/>},
   //6.2.4 Childhood
   {path: `${process.env.PUBLIC_URL}/CBT_Intake_Sex_D/Childhood`, Component : <Childhood/>},
   //6.2.5 Social Behavior 
   {path: `${process.env.PUBLIC_URL}/CBT_Intake_Sex_D/SocialBehavior`, Component : <SocialBehavior/>},
    //6.2.6 Legal 
   {path: `${process.env.PUBLIC_URL}/CBT_Intake_Sex_D/Legal`, Component : <Legal/>},
    //6.2.7 Patient Behavior 
    {path: `${process.env.PUBLIC_URL}/CBT_Intake_Sex_D/PatientBehavior`, Component : <PatientBehavior/>},

     //6.3 Sexual Desire 
     {path: `${process.env.PUBLIC_URL}/CBT_Intake_Sex_D/SexualDesire`, Component : <SexualDesire/>},

   //Brief Intervation
   { path: `${process.env.PUBLIC_URL}/Brief_Intervation/BriefIntervation`, Component : <BriefIntervation/>},
