        ...
        <Col xl="5" className="box-col-12 des-xl-100">
          <Row>
            ...
            <Col xl="6" md="3" sm="6" className="box-col-3 des-xl-25 rate-sec">
              <IncomeCard iconClass={<Icon1 />} amount="8,50,49" title="Total Patients" percent="95.54%" />
            </Col>
            <Col xl="6" md="3" sm="6" className="box-col-3 des-xl-25 rate-sec">
              <IncomeCard iconClass={<Icon2 />} amount="2,03,59" title="Pending assessments" percent="90.54%" />
            </Col>
          </Row>
        </Col>
        <IncomeChartClass />
